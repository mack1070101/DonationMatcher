...
public class RecipientTest {
    ...
    public void testGoodRecipient(){
        Recipient r = new Recipient(goodPerson.getUuid(), 37.809052, -122.483365,
    ...
    public void testPickwithBadLon(){
                Recipient r = new Recipient(goodPerson.getUuid(), 3007.809052, -122.483365,
                7, 44536, 44382, 19514, 12035,
                18094, 41561, 55924);
    }
    ...
    public void testPickwithBadLat(){
                Recipient r = new Recipient(goodPerson.getUuid(), 37.809052, -10022.483365,
                7, 44536, 44382, 19514, 12035,
                18094, 41561, 55924);
    }
